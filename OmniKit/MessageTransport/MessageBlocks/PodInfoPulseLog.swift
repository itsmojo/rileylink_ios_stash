...
// returns (up to) the most recent 50 32-bit pulse entries from pulse log
...
// returns (up to) the most previous 50 32-bit pulse entries from pulse log
public struct PodInfoPulseLogPrevious : PodInfo {
    ...
    public init(encodedData: Data) throws {
        ...
        let nEntriesCalculated = nLogBytesReturned / 4
...
public func createPulseLog(encodedData: Data, logStartByteOffset: Int, nEntries: Int) -> [UInt32] {
